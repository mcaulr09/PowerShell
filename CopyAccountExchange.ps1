...
If ($NewUser -eq $Null) 
{
    Write-Host -ForegroundColor Green "Username doesn't exist, creating user"

}
Else 
{
    Write-Host -ForegroundColour Red "Username already exists, choosing next letter in sequence"
}
